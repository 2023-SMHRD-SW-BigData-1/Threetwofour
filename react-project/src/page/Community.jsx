...
const Community = () => {
  ...
  useEffect(() => {
    ...
    let garaData = [
      { num: 1, writer: '조서연', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 1', title: '제목  1' },
      { num: 2, writer: '오승원', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 2', title: '제목  2' },
      { num: 3, writer: '홍경표', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 3', title: '제목  3' },
      { num: 4, writer: '박지원', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 4', title: '제목  4' },
      { num: 5, writer: '남건일', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 5', title: '제목  5' },
      { num: 6, writer: '양동하', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 6', title: '제목  6' },
      { num: 7, writer: '박희주', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 7', title: '제목  7' },
      { num: 8, writer: '정윤지', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 8', title: '제목  8' },
      { num: 9, writer: '이준', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 9', title: '제목  9' },
      { num: 10, writer: '정준옥', date: new Date().toLocaleDateString(), count: 20, content: '테스트 내용 10', title: '제목 10' },
